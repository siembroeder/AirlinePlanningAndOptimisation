...
def main():
    ...
    pop_path = r"..\..\Assignment1\Data\pop_gdp.xlsx"
    ...
    demand_path = r"..\..\Assignment1\Data\DemandGroup7.xlsx"
    ...
    demand_data_2021               = demand_data_week.values                                # Demand per week WHY PER YEAR???
    ...
    fit_percentage = check_fit_route(ij_data_2021, gravity_coeffs, plot=True)
