...
def main():
    # Load PMF Data
    source_data = "Exercise" # Options: "Exercise", "Assignment"
    source_data = "Assignment" 
    ex_sheets   = ["Flights", "Itineraries", "Recapture"] # Identical for Exercise and Assignment
    ...
    # Initialize model
    m = Model('keypath')
    m.params.LogFile = f'Question2/exercise_lec4/keypath_pmf/Keypath'+source_data+'.log'
    ...
    if m.status == GRB.OPTIMAL or m.status == GRB.TIME_LIMIT:
        m.write('Question2/exercise_lec4/keypath_pmf/KeypathModel'+source_data+'.lp')
